<div class="container mt-20 max-lg:px-8 max-md:mt-8 max-sm:mt-7 max-sm:!px-4">
    ...
    <div class="scrollbar-hide mt-10 flex gap-8 overflow-auto pb-2.5 max-md:grid max-md:grid-cols-2 max-md:gap-x-4 max-md:gap-y-5 max-md:overflow-visible max-md:pb-0 max-md:mt-5 max-sm:gap-x-4 max-sm:gap-y-5">
        <x-shop::shimmer.products.cards.grid
            class="min-w-[291px] max-md:min-w-0 max-md:w-full max-sm:min-w-0 max-sm:w-full"
            :count="4"
        />
    </div>
