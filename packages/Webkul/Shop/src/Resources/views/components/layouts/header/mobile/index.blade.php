                            ...
                            <x-slot:content>
                                ...
                                <div class="mt-6 flex gap-4">
                                    ...
                                    <a
                                        ...
                                        class="primary-button m-0 mx-auto block w-max rounded-2xl px-7 py-4 text-center text-base ltr:ml-0 rtl:mr-0"
                                    >
                                    ...
                                    <a
                                        ...
                                        class="secondary-button m-0 mx-auto block w-max rounded-2xl px-7 py-3.5 text-center text-base ltr:ml-0 rtl:mr-0"
                                    >
