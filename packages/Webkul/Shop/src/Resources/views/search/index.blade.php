                ...
                <div class="flex items-start gap-10 max-lg:gap-5 md:mt-10">
                    ...
                    <div class="flex-1">
                        ...
                        <div v-else>
                            <!-- Product Card Shimmer Effect -->
                            <template v-if="isLoading">
                                <div class="mt-8 grid grid-cols-3 gap-8 max-1060:grid-cols-2 max-md:grid-cols-2 max-md:gap-x-4 max-md:gap-y-5 max-sm:mt-5 max-sm:justify-items-center">
                            ...
                            <template v-else>
                                <template v-if="products.length">
                                    <div class="mt-8 grid grid-cols-3 gap-8 max-1060:grid-cols-2 max-md:grid-cols-2 max-md:mt-5 max-md:justify-items-center max-md:gap-x-4 max-md:gap-y-5">
                                        <x-shop::products.card
                                            ::mode="'grid'"
                                            v-for="product in products"
