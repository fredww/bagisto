            ...
            <div class="w-[455px] max-w-full max-sm:w-full">
                ...
                >
                    ...
                    <template v-else>
                        ...
                        <div class="flex flex-wrap items-center gap-3" v-if="attribute.swatch_type == 'toggle'">
                                    ...
                                    >
                                        ...
                                        >
                                            <input
                                                ...
                                                :value="option.id"
                                                v-bind="field"
                                                :id="'toggle_attribute_' + attribute.id + '_' + option.id"
                                                class="sr-only peer"
