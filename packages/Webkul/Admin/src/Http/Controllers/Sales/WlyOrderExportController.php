...
use Webkul\Admin\Jobs\WlyOrderExportJob;

class WlyOrderExportController extends Controller
{
    public function start(): JsonResponse
    {
        ...
        Bus::dispatch(new WlyOrderExportJob($task->id, $startDate ?: null, $endDate ?: null));
    ...
    public function status(int $id): JsonResponse
    {
        ...
        return response()->json([
            ...
            'downloadUrl'    => $task->file_path ? route('admin.sales.orders.wly_export.download', $task->id) : null,
