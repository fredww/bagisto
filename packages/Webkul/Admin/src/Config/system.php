    ...
    [
        ...
        'fields' => [
            ...
            [
                ...
                'type'          => 'text',
                'default'       => config('themes.default_styles.font_family'),
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'font_heading',
                ...
                'type'          => 'text',
                'default'       => config('themes.default_styles.font_heading'),
                'channel_based' => true,
                'locale_based'  => false,
            ],
            ...
            [
                ...
                'type'          => 'text',
                'default'       => config('themes.default_styles.primary_color'),
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'primary_dark',
                ...
                'type'          => 'text',
                'default'       => config('themes.default_styles.primary_dark'),
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'primary_light',
                ...
                'type'          => 'text',
                'default'       => config('themes.default_styles.primary_light'),
                'channel_based' => true,
                'locale_based'  => false,
            ],
            ...
            [
                ...
                'type'          => 'text',
                'default'       => config('themes.default_styles.secondary_color'),
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'accent_color',
                ...
                'type'          => 'text',
                'default'       => config('themes.default_styles.accent_color'),
                'channel_based' => true,
                'locale_based'  => false,
            ],
            ...
            [
                ...
                'type'          => 'text',
                'default'       => config('themes.default_styles.neutral_dark'),
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'neutral_medium',
                ...
                'type'          => 'text',
                'default'       => config('themes.default_styles.neutral_medium'),
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'neutral_light',
                ...
                'type'          => 'text',
                'default'       => config('themes.default_styles.neutral_light'),
                'channel_based' => true,
                'locale_based'  => false,
            ],
            ...
            [
                ...
                'type'          => 'text',
                'default'       => config('themes.default_styles.success_color'),
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'warning_color',
                ...
                'type'          => 'text',
                'default'       => config('themes.default_styles.warning_color'),
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'error_color',
                'title'         => 'Error Color',
                'type'          => 'text',
                'default'       => config('themes.default_styles.error_color'),
                'channel_based' => true,
                'locale_based'  => false,
            ],
            ...
            [
                ...
                'type'          => 'text',
                'default'       => config('themes.default_styles.button_bg'),
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'button_text',
                ...
                'type'          => 'text',
                'default'       => config('themes.default_styles.button_text'),
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'nav_bg',
                ...
                'type'          => 'text',
                'default'       => config('themes.default_styles.nav_bg'),
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'nav_text',
                ...
                'type'          => 'text',
                'default'       => config('themes.default_styles.nav_text'),
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'footer_bg',
                ...
                'type'          => 'text',
                'default'       => config('themes.default_styles.footer_bg'),
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'footer_text',
                ...
                'type'          => 'text',
                'default'       => config('themes.default_styles.footer_text'),
                'channel_based' => true,
                'locale_based'  => false,
            ],
        ],
    ], [
        'key'    => 'general.design.theme_settings',
        'name'   => 'Layout & Functionality',
        'info'   => 'Configure layout options and functional elements',
        'sort'   => 5,
        'fields' => [
            [
                'name'          => 'product_grid_columns',
                'title'         => 'Product Grid Columns (Desktop)',
                'type'          => 'select',
                'default'       => '4',
                'options'       => [
                    [
                ...
                'name'          => 'enable_sticky_add_to_cart',
                'title'         => 'Enable Sticky Add to Cart (Mobile)',
                'type'          => 'boolean',
                'default'       => true,
                'channel_based' => true,
                'locale_based'  => false,
                ...
                'title'         => 'Show Trust Badges on PDP',
                'type'          => 'boolean',
                'default'       => true,
                'channel_based' => true,
                'locale_based'  => false,
        ...
        'fields' => [
            [
                ...
                'info'          => 'admin::app.configuration.index.sales.payment-methods.merchant-id-info',
                'type'          => 'text',
                'depends'       => 'active:1',
                'validation'    => 'required_if:active,1',
                'channel_based' => true,
